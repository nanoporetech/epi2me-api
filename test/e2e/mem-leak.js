/**
 * This isn't a production test
 * - it's just something to see monitor what happens when you move around a load of files
 * - Check that the api doesn't have a memory leak
 */
...
var fileCount      = 10000; // creating 100K temporary files
            ...
            for (var i = 0; i < fileCount; i++) {
                fileQ.defer(function (done) {
                    setTimeout(function () {
                        ...
                        let batch = 'batch_' + (j++ / 1000).toFixed(0);
