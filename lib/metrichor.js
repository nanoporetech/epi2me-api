    ...
    _config = {
        options: {
            ...
            remoteShutdownCb       : opts.remoteShutdownCb,                 // callback for remote shutdown of
             ...
             /* upload settings */
            awsAcceleration        : opts.awsAcceleration === "on",         // Use AWS Acceleration - boosts download / upload speeds
            ...
            uploadPoolSize         : 4,                                     // Parallelism of upload queue
            ...
            downloadPoolSize       : opts.downloadPoolSize || 4,            // MC-505 how many things to download at once
...
metrichor.prototype = {
    ...
    sessionedS3: function () {
        this.session();
        return new AWS.S3({useAccelerateEndpoint: _config.options.awsAcceleration, StorageClass: 'REDUCED_REDUNDANCY'});
    },
