...
metrichor.prototype = {
    ...
    autoConfigure: function (instance, autoStartCb) {
        ...
        _config.instance.user_data            = instance.user_data; // MC-2387 - parameterisation
    ...
    sendMessage: function (sqs, objectId, item, successCb) {
        var that    = this,
            message = {
                ...
                user_data:            _config.instance.user_data, // MC-2397 - bind param_config to each sqs message
                apikey:               _config.options.apikey,
