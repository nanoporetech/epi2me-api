...
metrichor.prototype = {
    ...
    autoStart: function (id, cb) {
        ...
        that.start_workflow(id, function start_workflowCB(workflowError, instance) {
            ...
            _config.instance.docker_image        = instance.docker_image;
    ...
    autoConfigure: function (instance, autoStartCb) {
        ...
        var fileName = (instance.id_workflow_instance) ? "telemetry-" + instance.id_workflow_instance +".log" : "telemetry.log";
    ...
    sendMessage: function (sqs, objectId, item, successCb) {
        var that    = this,
            message = {
                ...
                dockerImage:          _config.instance.docker_image,
