...
"use strict";
var AWS, queue, fs, path, os, mkdirp, proxy, _config, underscore, utils, uploadWorker, downloadWorker;
...
metrichor.prototype = {
    ...
    stats: function (key) {
        if (this._stats[key]) {
            ...
            if (key === "upload") {
                ...
                this._stats.upload.total = this._uploadedFiles.length + this._stats.upload.enqueued;
            }
        }
                    ...
                    .forEach(function (chunk) {
                        ...
                        that.inputBatchQueue.defer(function (batch_complete) {
                            ...
                            chunk.forEach(function (item) {
                                uploadWorkerPool.defer(function (completeCb) {
    ...
    uploadHandler: function (item, done) {
