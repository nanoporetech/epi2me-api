...
class metrichor {
    ...
    workflow_instances(cb, query) {
        if(query && query.run_id) {
            ...
            //'https://epi2me-staging.nanoporetech.com/workflow_instance/wi.json?show=all&columns%5B0%5D%5Bname%5D=run_id&columns%5B0%5D%5Bsearchable%5D=true&columns%5B0%5D%5Bsearch%5D%5Bregex%5D=true&columns%5B0%5D%5Bsearch%5D%5Bvalue%5D=89de623b80440d086a0e4f9b9b023f7ff53a9aec' | jq -r '.data[].id_ins'
                ...
                let mapped = json.data.map(
                    (o) => {
                        return {
                            ...
                            id_workflow: o.app_ids,
                            flowcell_id: o.id_flo,
                            run_id: o.run_id,
                            description: o.desc,
                            rev: o.rev
                        };
