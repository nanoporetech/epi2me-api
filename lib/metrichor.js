...
//                            that.log.info("discovered queue " + queueURL);
            ...
            that._downloadQueueInterval = setInterval(timedChecker, 4000); // Should be a setTimeout with variable delay rather than static Xms poll. if this is too short then when uploadqueue is short, readdirs can still run into each other
            return;
        }
