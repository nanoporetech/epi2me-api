...
function metrichor(opt_string) {
    ...
    _config = {
        options: {
            ...
            uploadQueueLimit       : 200,           // Maximum number of files in the queue at once
            ...
            downloadPoolSize       : opts.downloadPoolSize || 15,           // MC-505 how many things to download at once
...
//                that.log.info(JSON.stringify(token));
    ...
    autoConfigure: function (instance, autoStartCb) {
        ...
        that._seenFiles = {};
        that._fileCheckInterval = setInterval(function () {
    ...
    loadUploadFiles: function () {
        ...
        function destroy(msg) {
            ...
            that.log.warn(msg, ' destroying _readdirpStream');
        }
        ...
        that._readdirpStream
            .on('warn', that.log.warn.bind(that))
            .on('error', destroy)
