...
//        that.log.info("sending message " + JSON.stringify(message));
        ...
        try {
            sqs.sendMessage({
                ...
                mkdirp(folderTo, function (mkdirException) {
                    ...
                    that._moveUploadedFile(fileFrom, fileTo, item, successCb);
                });
            });
    ...
    _moveUploadedFile: function (fileFrom, fileTo, fileName, successCb) {
        ...
        var that = this, readStream, writeStream, streamErrorFlag;
