...
MetrichorAPI = (function() {
  function MetrichorAPI(options1) {
    ...
    this.options.agent_version = this.options.agent_version || '2.41.1';
  ...
  MetrichorAPI.prototype.getToken = function(options, done) {
    var makeRequest, tries;
    tries = 0;
    return (makeRequest = (function(_this) {
      return function() {
        tries += 1;
        return _this.post("token", options, function(error, token) {
          if (error || !token) {
            if (tries < 3) {
              return makeRequest();
            }
