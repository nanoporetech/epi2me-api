...
AWS = (function(superClass) {
  ...
  function AWS(options1, api, ssd) {
    ...
    this.queueDownload = bind(this.queueDownload, this);
  ...
  AWS.prototype.gotFileList = function(messages) {
    ...
    return async.eachLimit(messages.Messages, 10, this.queueDownload, (function(_this) {
      return function(error) {
        if (error) {
          return _this.scanFailed('download', error);
        }
  ...
  AWS.prototype.queueDownload = function(sqsMessage, next) {
    return this.limiter.submit(this.downloadFile, sqsMessage, next);
  };
