...
export default class REST {
    ...
    instance_token(id, cb) { /* should this be passed a hint at what the token is for? */
        return utils._post("token", { id_workflow_instance: id }, this.options, cb);
    }

    install_token(id, cb) {
        return utils._post("token/install", { id_workflow: id }, this.options, cb);
    }
...
async workflows(cb) {
    ...
    workflow(id, obj, cb) {
        if (cb) {
            ...
            return utils._put("workflow", id, obj, this.options, cb);
        }
        ...
        if (id && typeof id === "object") {
            ...
            cb = obj;
            obj = id;
            return utils._post("workflow", obj, this.options, cb);
        }
    ...
    start_workflow(config, cb) {
        return utils._post("workflow_instance", config, this.options, cb);
    }
