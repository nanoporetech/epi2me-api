...
MetrichorSync = (function(superClass) {
  ...
  function MetrichorSync(options) {
    ...
    this.ssd = new SSD(this.options, this.api);
  ...
  MetrichorSync.prototype.stats = function(key) {
    var processed, ref, ref1, ref2, ref3, ref4, ref5;
    if (this.ssd.stats && ((ref = this.aws.stats) != null ? ref.sqs : void 0)) {
      processed = this.ssd.stats.downloaded + this.aws.stats.sqs.output.visible + this.aws.stats.sqs.output.flight;
    }
    this.emit('progress', this.latestStats = {
      instance: this.api.loadedInstance,
      upload: {
        success: ((ref1 = this.ssd.stats) != null ? ref1.uploaded : void 0) || 0,
        failure: {},
        queueLength: 0,
      ...
      return function(error) {
        ...
        return _this.ssd.checkPermissions(function(error) {
          ...
          return _this.ssd.start(function(error) {
            ...
            return _this.ssd.createTelemetry(_this.api.loadedInstance, function(error) {
              if (error) {
                _this.ssd.stop();
                return typeof done === "function" ? done(error) : void 0;
              }
