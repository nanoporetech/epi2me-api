  ...
  MetrichorSync.prototype.stats = function(key) {
    ...
    this.emit('progress', this.latestStats = {
      ...
      upload: {
        ...
        queueLength: (ref1 = this.aws.stats) != null ? ref1.uploading : void 0,
      ...
      download: {
        ...
        queueLength: (ref5 = this.aws.stats) != null ? ref5.downloading : void 0,
        totalSize: (ref6 = this.ssd.stats) != null ? ref6.downloaded : void 0
      },
      all: {
        ssd: this.ssd.stats,
        aws: this.aws.stats
