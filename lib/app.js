...
MetrichorSync = (function(superClass) {
  ...
  MetrichorSync.prototype.status = function(message) {
    ...
    if (!((ref1 = this.api) != null ? ref1.instance : void 0)) {
      return;
    }
  ...
  MetrichorSync.prototype.stats = function(key) {
    ...
    this.emit('progress', this.latestStats = {
      ...
      upload: {
        ...
        totalSize: ((ref2 = this.ssd.stats) != null ? ref2.uploaded : void 0) || 0,
      ...
      download: {
        ...
        totalSize: ((ref6 = this.ssd.stats) != null ? ref6.downloaded : void 0) || 0
      },
      all: {
        ssd: this.ssd.stats,
        aws: this.aws.stats
